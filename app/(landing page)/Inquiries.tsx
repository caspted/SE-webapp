...
const Inquiries = () => {
  ...
  return (
    <div className="px-4 md:px-8">
      <div className="md:flex md:space-x-4 lg:space-x-8 xl:space-x-16">
        ...
        <div className="flex-col flex flex-1 space-y-8 my-12 md:my-0 md:justify-center">
          <div className="w-72 rounded-xl bg-secondary-300 p-4 md:w-full">
            <div
              className="flex justify-between items-center cursor-pointer"
              onClick={() => toggleAccordion(1)}
            >
              <h2 className="text-xl font-semibold text-shades-light w-56 md:w-80 lg:w-96">
      ...
      <form className="space-y-4 my-12 flex-col flex flex-1">
        <div>
          <input
            type="email"
            className="text-shades-dark w-full h-10 rounded-xl p-2"
            placeholder="Type your email address here..."
          />
        </div>
        <div>
          <textarea
            className=" text-shades-dark w-full h-80 rounded-xl placeholder p-2 overflow-y:auto resize:none"
