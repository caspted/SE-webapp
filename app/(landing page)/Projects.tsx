  ...
  return (
    <main className="flex flex-col min-h-screen relative">
      <h1 className="py-20 px-[3vw]">
        {"What we've achieved, and what has happened"}
      </h1>
      <div className="relative">
        <div className="absolute h-40 w-full bg-gradient-to-b from-primary-500 via-primary-500"></div>{" "}
        <div
          ref={container}
        ...
        >
          <ProjectColumn
            ...
            className="hidden md:flex -top-[40%]"
            y={y}
          />
          <ProjectColumn
        ...
        <div className="absolute bottom-0 h-40 w-full bg-gradient-to-t from-primary-500 via-primary-500"></div>
      </div>
